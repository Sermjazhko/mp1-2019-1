...
public:
  ...
  bool authorization(int number, string &_password);//авторизаци€ клиента
  void deposit_information();// информаци€ о депозите
  bool check_open();//проверить на открытие депозита 
  void open_deposit(int time, int salary);//открыть депозит
  int deposit_(); // показать состо€ние 
  void withdraw();//сн€ть проценты
...
void Deposit::registration()
{
  ...
  cin >> name;
  cin >> patronymic;
  cout << " оличество средств на счету:" << endl; //фиксированное?
  cin >> add;
  while (i == 0)
  {
    cout << "ѕароль (от 3 симовол без пробелов):" << endl;
    cin >> pass;
    i++;
    if (pass.length() < 3)
      i = 0;
  ...
  cout << "¬аш номер счета: " << setfill('0') << setw(4) << index << endl;
  index++;
}
...
{
  ProcessingCenter check;
  cout << "ƒоступные депозиты: " << endl;
  cout << "—умма депозита          " << "—рок:      " << "ѕроцентные ставки:  " << endl;
  if (check.get_salary(account_number) > 1000000)
  {
    cout << "1 млн.                  " << "3 мес€ца   " << "8%" << endl;
    cout << "                        " << "6 мес€ца   " << "10%" << endl;
    cout << "                        " << "1 год      " << "11%" << endl;
    cout << "                        " << "2 года     " << "12%" << endl;
    cout << "                        " << "3 года     " << "14%" << endl;
  }
  ...
  {
    cout << "от 500 тыс. до 1 млн.   " << "3 мес€ца   " << "7%" << endl;
    cout << "                        " << "6 мес€ца   " << "8%" << endl;
    cout << "                        " << "1 год      " << "9%" << endl;
    cout << "                        " << "2 года     " << "10%" << endl;
    cout << "                        " << "3 года     " << "11%" << endl;
  }
  ...
  {
    cout << "от 100 тыс. до 500 тыс. " << "3 мес€ца   " << "6%" << endl;
    cout << "                        " << "6 мес€ца   " << "6,6%" << endl;
    cout << "                        " << "1 год      " << "7%" << endl;
    cout << "                        " << "2 года     " << "8%" << endl;
    cout << "                        " << "3 года     " << "9%" << endl;
  }
  cout << "до 100 тыс.             " << "3 мес€ца   " << "5%" << endl;
  cout << "                        " << "6 мес€ца   " << "5,5%" << endl;
  cout << "                        " << "1 год      " << "6%" << endl;
  cout << "                        " << "2 года     " << "7%" << endl;
  cout << "                        " << "3 года     " << "7,5%" << endl;
  cout << "—умма на счЄте: " << check.get_salary(account_number) << endl;
}
