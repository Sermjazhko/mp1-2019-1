...
public:
  ...
  LengthConverter(float n)
  {
    meters = n;
  }
  LengthConverter(const LengthConverter &len)
  {
    meters = len.meters;
  }
  LengthConverter& operator=(const LengthConverter &len)
  {
    meters = len.meters;
    return *this;
  }
...
int main(void)
{
  ...
  LengthConverter len(a);
  LengthConverter check;
